        ...
        <div class="top-bar">
            <div class="container">
                <div class="top-bar-left-a">
                    <?php if ( mipro_get_opt('kft_slogan_header_content') ) : ?>
                        <?php echo do_shortcode(mipro_get_opt('kft_slogan_header_content')); ?>
                    <?php endif; ?>
                </div>
            </div>
        </div>
