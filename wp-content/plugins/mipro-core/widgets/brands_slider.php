<?php
add_action('widgets_init', 'kft_brands_slider_load_widgets');

function kft_brands_slider_load_widgets() {
	register_widget('Mipro_Brands_Slider_Widget');
}

if ( ! class_exists('Mipro_Brands_Slider_Widget') ) {
	class Mipro_Brands_Slider_Widget extends WP_Widget {

		function __construct() {
			$widgetOps = array( 'classname' => 'kft-brands-slider', 'description' => esc_html__('Display your brands in a carousel slider', 'mipro-core' ) );
			parent::__construct('kft_brands_slider', esc_html__('Mipro - Brands Slider', 'mipro-core'), $widgetOps);
		}

		function widget( $args, $instance ) {
			extract( $args );
			
			if ( ! shortcode_exists( 'kft_brands_slider' ) ) {
				return;
			}
			...
			$shortcode_content = '[kft_brands_slider ';
		...
		?>
			<p>
				<label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Enter your title', 'mipro-core'); ?> </label>
				<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
			</p>

			<p>
				<label for="<?php echo $this->get_field_id('categories'); ?>"><?php esc_html_e('Input brand categories', 'mipro-core'); ?> </label>
				...
				<span class="description"><?php esc_html_e('A comma separated of list brand category slugs', 'mipro-core'); ?></span>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id('per_page'); ?>"><?php esc_html_e('Number of posts to show', 'mipro-core'); ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('rows'); ?>"><?php esc_html_e('Number of rows', 'mipro-core'); ?> </label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('active_link'); ?>"><?php esc_html_e('Activate link', 'mipro-core'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_nav'); ?>"><?php esc_html_e('Show navigation button', 'mipro-core'); ?></label>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id('margin_image'); ?>"><?php esc_html_e('Margin between images', 'mipro-core'); ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('extra_class'); ?>"><?php esc_html_e('Extra class', 'mipro-core'); ?> </label>
